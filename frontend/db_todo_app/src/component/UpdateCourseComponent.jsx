            ...
            <div>
                ...
                <Form>
                    <Form.Group controlId="formBasicImmutableName">
                        ...
                        <Form.Control type="text" name="name" placeholder="Updated Name" id={this.state.u_id} value={this.state.u_name} onChange={this.handleNameChange}  />
                    </Form.Group>
                    ...
                    <Modal show={this.state.show} onHide={this.handleClose}>
                        ...
                        <Modal.Body>You can change your Plan later if necessary.</Modal.Body>
                        <Modal.Footer>
                    ...
                    <div className="row">
                        <Button variant="info" onClick={this.goBack} size="sm">Return</Button>{' '}
                    </div>
                </Form>
            </div>
        );
